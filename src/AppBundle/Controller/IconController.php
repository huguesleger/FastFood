...
class IconController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('admin/icon/index.html.twig', array(
            'icons' => $icons,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('admin/icon/new.html.twig', array(
            'icon' => $icon,
    ...
    public function showAction(Icon $icon)
    {
        ...
        return $this->render('admin/icon/show.html.twig', array(
            'icon' => $icon,
    ...
    public function editAction(Request $request, Icon $icon)
    {
        ...
        return $this->render('admin/icon/edit.html.twig', array(
            'icon' => $icon,
